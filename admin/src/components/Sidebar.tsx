...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const { admin, logout, demoMode, toggleDemoMode } = useAuth();
      ...
      >
        ...
        <div className="p-3 border-t border-neutral-200 bg-neutral-50/50 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-2 rounded-md border border-neutral-200 bg-white hover:bg-neutral-50 text-xs transition-colors"
          >
            <div className="text-left">
              <span className="font-medium text-neutral-800 block text-[11px]">Data Source</span>
              <span className="text-[10px] text-neutral-500">
                {demoMode ? 'Demo / Offline Data' : 'Live MongoDB'}
              </span>
            </div>
            {demoMode ? (
